...
private:
    ...
    static QImage areaDownsample(const QImage &, const QSize &, const Cancel &cancel={});
    static void measure(const QImage &, const QImage &, double &, double &, int &, const Cancel &cancel={});
};
