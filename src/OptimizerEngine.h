...
class OptimizerEngine final : public QObject {
    ...
    Q_PROPERTY(QString materialUrl READ materialUrl NOTIFY materialUrlChanged)
...
public:
    ...
    QString materialUrl()const{return m_materialUrl;}
...
signals:
    void sourceUrlChanged(); void resultUrlChanged(); void referenceUrlChanged(); void materialUrlChanged(); void statusChanged(); void reportChanged();
    void outputPathChanged();
    void progressChanged(); void busyChanged();
    void telemetryChanged();
private:
    QString localPath()const; void setProgress(double,const QString&);
    QString m_sourceUrl,m_resultUrl,m_referenceUrl,m_materialUrl,m_status="Перетащите PNG",m_report,m_outputPath; double m_progress=0; bool m_busy=false;
